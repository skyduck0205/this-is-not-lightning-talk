(function(global) {
  ...
  window.requestFullscreen = document.documentElement.requestFullscreen ||
    document.documentElement.mozRequestFullScreen ||
    document.documentElement.webkitRequestFullScreen ||
    document.documentElement.msRequestFullscreen;
  window.cancelFullscreen = document.exitFullscreen ||
  ...
  function App(node) {
    ...
    function init() {
      ...
      if (window.requestFullscreen && window.cancelFullscreen) {
        self.fullscreenButton.addEventListener('click', onFullscreenClick);
      } else {
        hide(self.fullscreenButton);
      }
    ...
    function onFullscreenClick() {
      if (!document.fullscreenElement && !document.mozFullScreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement) {
        window.requestFullscreen.call(document.documentElement);
        self.fullscreenButton.innerText = 'fullscreen_exit';
      } else {
        window.cancelFullscreen.call(document);
        self.fullscreenButton.innerText = 'fullscreen';
      }
    }
  }
